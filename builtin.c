...
/**
 * get_builtin - Finds the corresponding builtin function for a given
 *		command.
...
/**
 * shellie_exit - Exits the shell by shell with the given status value.
...
/**
 * shellie_cd - It can change the current directory of the shellby process.
...
/**
 * shellie_help - It can display information about shellby builtin commands.
 * @args: An array of arguments.
